...
/*--------------------------------------------------------------
 * 11. Data Seeder - Demo Content
 *------------------------------------------------------------*/
/**
 * Run seeder via: /wp-admin/admin.php?page=tav-dashboard&tav_seed=1
 */
add_action('admin_init', 'tav_maybe_run_seeder');

function tav_maybe_run_seeder(): void
{
    if (!isset($_GET['tav_seed']) || '1' !== $_GET['tav_seed']) {
        return;
    }
    ...
    $demo_data = [
        [
            ...
            'fields' => [
                ...
                'bio' => 'Passionate about climate change and sustainable living.',
                'platforms_repeater' => [
                    [
                        ...
                        'engagement_rate' => 4.2,
                        'profile_url' => 'https://instagram.com/sarah_eco',
                        'niche_tags' => ['climate', 'lifestyle'],
                    ],
                    [
                        ...
                        'engagement_rate' => 5.1,
                        'profile_url' => 'https://tiktok.com/@sarah_eco',
                        'niche_tags' => ['climate'],
                    ],
                ],
                'campaign_status' => 'verified',
                'authenticity_score' => 85,
                'private_contact' => 'sarah.m@example.com',
                'verification_notes' => 'Verified ID and past campaign performance.',
            ],
            'tags' => ['Eco-Warrior', 'Berlin'],
        ],
        [
            'title' => 'Marcus Weber',
            'fields' => [
                ...
                'platforms_repeater' => [
                    [
                        ...
                        'engagement_rate' => 6.8,
                        'profile_url' => 'https://tiktok.com/@marcustech',
                        'niche_tags' => ['tech'],
                    ],
                ],
                'campaign_status' => 'verified',
                'authenticity_score' => 92,
                'private_contact' => 'm.weber@tech-talent.de',
            ],
        ...
        [
            ...
            'fields' => [
                ...
                'bio' => 'Environmental science student sharing knowledge.',
                'platforms_repeater' => [
                    [
                        ...
                        'engagement_rate' => 3.5,
                        'profile_url' => 'https://youtube.com/c/ElenaKovac',
                        'niche_tags' => ['climate', 'health'],
                    ],
                ],
                'campaign_status' => 'verified',
                'authenticity_score' => 78,
                'private_contact' => 'elena.kovac@greenworld.org',
            ],
            'tags' => ['Education'],
        ],
        [
            ...
            'fields' => [
                ...
                'bio' => 'Med student posting about health and wellness.',
                'platforms_repeater' => [
                    [
                        'platform_name' => 'instagram',
                        'handle' => '@dr.david',
                        ...
                        'engagement_rate' => 5.1,
                        'profile_url' => 'https://instagram.com/dr.david',
                        'niche_tags' => ['health'],
                    ],
                    [
                        'platform_name' => 'youtube',
                        ...
                        'engagement_rate' => 4.8,
                        'profile_url' => 'https://youtube.com/c/DrDavidChen',
                        'niche_tags' => ['health'],
                    ],
                ],
                'campaign_status' => 'pending',
                'authenticity_score' => 65,
                'private_contact' => 'david@chen-health.com',
            ],
            'tags' => ['Health', 'USA'],
        ],
        [
            ...
            'fields' => [
                ...
                'platforms_repeater' => [
                    [
                        ...
                        'engagement_rate' => 5.5,
                        'profile_url' => 'https://instagram.com/sophia.mode',
                        'niche_tags' => ['fashion', 'lifestyle'],
                    ],
                ],
                'campaign_status' => 'active',
                'authenticity_score' => 88,
                'private_contact' => 'sophia.rossi@milano-mode.it',
            ],
            'tags' => ['Fashion', 'Milan'],
        ],
    ];
    ...
    foreach ($demo_data as $data) {
        ...
        $exists = get_page_by_title($data['title'], OBJECT, 'storyteller');
        if ($exists) {
            continue;
        }
        ...
        if (!is_wp_error($post_id)) {
            ...
            // set tags
            if (isset($data['tags'])) {
                wp_set_object_terms($post_id, $data['tags'], 'storyteller_tag');
            }
        }
    }

    wp_safe_redirect(admin_url('admin.php?page=tav-dashboard&view=storytellers&seeded=1'));
    exit;
}
...
add_action('admin_notices', 'tav_seed_success_notice');
function tav_seed_success_notice()
{
    if (isset($_GET['seeded']) && '1' === $_GET['seeded']) {
        echo '<div class="notice notice-success is-dismissible"><p>' . esc_html__('Demo storytellers seeded successfully!', 'the-admin-vault') . '</p></div>';
    }
}
